                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        '\$${workshop.price}',
                        style: TextStyle(color: Color(0xFF240046), fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                ],
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      _buildChip(workshop.category, Colors.deepPurple, Colors.white),
                      SizedBox(width: 8),
                      _buildChip(workshop.level, Colors.grey.shade200, Colors.black),
                    ],
                  ),
                  SizedBox(height: 10),
                  Text(
                  ...
                  SizedBox(height: 5),
                  Text('by ${workshop.instructor}', style: TextStyle(color: Colors.grey)),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      Icon(Icons.calendar_today, size: 14, color: Colors.grey),
                      SizedBox(width: 5),
                      Text(workshop.date, style: TextStyle(color: Colors.grey[700])),
                    ],
                  ),
                  SizedBox(height: 5),
                  Row(
